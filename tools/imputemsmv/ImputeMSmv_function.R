...
imputemsmv <- function(DataMatrix,
  ...
  return(list(Datamatrix = DataMatrix_NoMV,
              sampleMetadata = sampleMetadata_MV,
              VariableMetadata = variableMetadata_MV))
}
# ========================================================.
...
plt_density <- function(df1, df2) {
  ...
  plot(density(logDataVector1),
       col = adjustcolor(color[1], alpha.f = 0.7), lty = 2, lwd = 2,
